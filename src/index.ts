...
export function activate(this: any, context: vscode.ExtensionContext) {
	...
	context.subscriptions.push(installSakura);
	context.subscriptions.push(uninstallSakura);
	context.subscriptions.push(updateSakura);

	console.log("Sakura Glowing is active!");
